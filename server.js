...
function removeNonIdValues(obj) {
  for (const key in obj) {
    if (key === 'Id') {
      continue; // skip 'id' key
    }
    if (typeof obj[key] === 'object') {
        removeNonIdValues(obj[key]); // call recursively
      ...
      "ShpInfReqDef" : {
        ...
        "UICmpt" : {
          ...
          "DisplayDsc" : {
            ...
            "DisplayTxt" : "Please upload Material Safety Doc contains liquid or powder items."
...
const result = removeNonIdValues(NestedJson);
// console.log(result);
